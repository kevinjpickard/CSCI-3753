...
About:
	Generates several I/O-bound processes with a specified process scheduler for benchmarking purposes.

Usage:	./iotest <scheduler protocol> <number of processes> <input filename> <output filename>
...
Acknowledgements:
	Uses some code from the supplied pi-sched.c and rw.c to generate the mixed process.
*/
